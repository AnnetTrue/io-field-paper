...
global invA ns x1 x2 s_jt v IV vfull theta1 theti thetj cdid cdindex theta2w 
...
ivvars={'engine_iv', 'horsepower_iv', 'fuelcons_iv', 'clearance_iv', 'trunk_iv', 'engine_fm', 'horsepower_fm', 'fuelcons_fm', 'clearance_fm', 'trunk_fm'};
iv=raw{:, ivvars};

price=raw{:,'price'}/1000;
x1=raw{:, {'comp1','comp2','comp3','comp4','comp5','comp6','comp7','comp8','comp9' }};
x1=[x1, price];
IV=[iv, x1(:, 2:10)];
...
nmkt = 5;     % number of markets = (# of cities)*(# of quarters)  %
nbrn = 25;     % number of brands per market. if the numebr differs by market% 
